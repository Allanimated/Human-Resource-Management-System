            ...
            <div key={index} className="experience-row">
              ...
              <div className="experience-cell">
                <button
                  ...
                  onClick={(event) => handleUpdate(event, experience.id)}
                >
                  Update
                </button>
                <button
                  ...
                  onClick={(event) => handleDelete(event, experience.id)}
                >
                  Delete
                </button>
              </div>
            ...
            <div className="experience-row">
              <div className="experience-cell">
                <input
                  type="text"
                  name="name"
                  value={experiences[experiences.length - 1].name}
                  onChange={(e) => handleChange(e, experiences.length - 1)}
                  placeholder="Name"
                  required
                />
              </div>
              <div className="experience-cell">
                <input
                  type="text"
                  name="job_title"
                  value={experiences[experiences.length - 1].job_title}
                  onChange={(e) => handleChange(e, experiences.length - 1)}
              ...
              <div className="experience-cell">
                <textarea
                  name="description"
                  value={experiences[experiences.length - 1].description}
                  onChange={(e) => handleChange(e, experiences.length - 1)}
              ...
              <div className="experience-cell">
                <label>
                  <input
                    type="date"
                    name="start_date"
                    value={experiences[experiences.length - 1].start_date}
                    onChange={(e) => handleChange(e, experiences.length - 1)}
                    required
                  />
                </label>
              ...
              <div className="experience-cell">
                <label>
                  <input
                    type="date"
                    name="end_date"
                    value={experiences[experiences.length - 1].end_date}
                    onChange={(e) => handleChange(e, experiences.length - 1)}
                    required
                  />
                </label>
