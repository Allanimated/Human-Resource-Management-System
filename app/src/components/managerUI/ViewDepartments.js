...
const Departments = () => {
  ...
  return (
    ...
    >
      <h1
        style={{ marginLeft: "270px", marginBottom: "20px", marginTop: "20px" }}
      >
        Departments
      </h1>
      <table
        className="ui striped table"
        style={{ width: "600px", marginLeft: "60px", marginBottom: "20px" }}
      >
        <thead>
          <tr>
      ...
      <div>
        {showCreateDepartment && (
          <AddDepartment
            onClose={handleCreateDepartmentClose}
        ...
        <button
          ...
          style={{ width: "200px", marginLeft: "200px", marginTop: "20px" }}
